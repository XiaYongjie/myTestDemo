 ...
 */
public class BookNavigatorHelper {
    ...
    private BookNavigatorHelper.OnNavigatorScrollListener mNavigatorScrollListener;
        ...
        if (mScrollState != ScrollState.SCROLL_STATE_IDLE) {
            ...
            if (normalDispatch) {
                if (leftToRight) {
                    ...
                    dispatchOnEnter(position-1, 1.0f - positionOffset, false, false);
                }
            } else {
    ...
    public void setNavigatorScrollListener(BookNavigatorHelper.OnNavigatorScrollListener navigatorScrollListener) {
