 ...
 */
public class BookCommonNavigator extends FrameLayout implements IPagerNavigator, BookNavigatorHelper.OnNavigatorScrollListener {
    ...
    private BookNavigatorHelper mBookNavigatorHelper;
    ...
    private DataSetObserver mObserver = new DataSetObserver() {
        ...
        public void onChanged() {
            mBookNavigatorHelper.setTotalCount(mAdapter.getCount());    // 如果使用helper，应始终保证helper中的totalCount为最新
            init();
        }
    ...
    public BookCommonNavigator(Context context) {
        super(context);
        mBookNavigatorHelper = new BookNavigatorHelper();
        mBookNavigatorHelper.setNavigatorScrollListener(this);
    }
    ...
    private void initTitlesAndIndicator() {
        for (int i = 0, j = mBookNavigatorHelper.getTotalCount(); i < j; i++) {
...
//                }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (mAdapter != null) {
            ...
            if (mReselectWhenLayout && mBookNavigatorHelper.getScrollState() == ScrollState.SCROLL_STATE_IDLE) {
                onPageSelected(mBookNavigatorHelper.getCurrentIndex());
                onPageScrolled(mBookNavigatorHelper.getCurrentIndex(), 0.0f, 0);
            }
        }
    }
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        if (mAdapter != null) {
            ...
            mBookNavigatorHelper.onPageScrolled(position, positionOffset, positionOffsetPixels);
            if (mIndicator != null) {
...
//                    if (scrollTo>0)
                        mScrollView.scrollTo((int) ((scrollTo + (nextScrollTo - scrollTo) * positionOffset)-((nextScrollTo - scrollTo))), 0);
//                    else
//                        mScrollView.scrollTo(0,0);
    ...
    public static int px2dip(Context context, float pxValue) {
        ...
        Log.e("=====","====px2dip==scale:"+scale+"===="+(pxValue / scale + 0.5f));
    ...
    public void onPageSelected(int position) {
        if (mAdapter != null) {
            mBookNavigatorHelper.onPageSelected(position);
            if (mIndicator != null) {
    ...
    public void onPageScrollStateChanged(int state) {
        if (mAdapter != null) {
            mBookNavigatorHelper.onPageScrollStateChanged(state);
            if (mIndicator != null) {
    ...
    public void setSkimOver(boolean skimOver) {
        mSkimOver = skimOver;
        mBookNavigatorHelper.setSkimOver(skimOver);
    }
